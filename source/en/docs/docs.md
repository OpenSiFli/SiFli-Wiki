# Chip Manual Collection

***Chip and Module Datasheets and User Manuals***
...
* SF32LB55x Series
    * Chip Introduction ([Chinese][中文简介55x], [EN][英文简介55x])
    * Chip Datasheet ([Chinese][中文规格书55x], [EN][英文规格书55x])
    * User Manual ([Chinese][中文用户手册55x], EN)
* SF32LB58x Series
    * Chip Introduction ([Chinese][中文简介58x], [EN][英文简介58x])
    * Chip Datasheet ([Chinese][中文规格书58x], [EN][英文规格书58x])
    * User Manual ([Chinese][中文用户手册58x], EN)
    * SF32LB58-MOD Module Datasheet ([Chinese][中文规格书58-MOD], EN)
* SF32LB56x Series
    * Chip Introduction ([Chinese][中文简介56x], [EN][英文简介56x])
    * Chip Datasheet ([Chinese][中文规格书56x], [EN][英文规格书56x])
    * User Manual ([Chinese][中文用户手册56x], EN)
    * SF32LB56-MOD Module Datasheet ([Chinese][中文规格书56-MOD], EN)
* SF32LB52x Lithium Battery-Powered Series
    * Chip Introduction ([Chinese][中文简介52x-vbat], [EN][英文简介52x-vbat])
    * Chip Datasheet ([Chinese][中文规格书52x-vbat], [EN][英文规格书52x-vbat])
    * User Manual ([Chinese][中文用户手册52x], [EN][英文用户手册52x])
    * SF32LB52-MOD-1 Module Datasheet ([Chinese][中文规格书52-MOD-1], EN)
* SF32LB52X 3.3 V-Powered Series
    * Chip Introduction ([Chinese][中文简介52X-3p3], [EN][英文简介52X-3p3])
    * Chip Datasheet ([Chinese][中文规格书52X-3p3], [EN][英文规格书52X-3p3])
    * User Manual ([Chinese][中文用户手册52x], [EN][英文用户手册52x])   
* SF30147
    * Chip Introduction ([Chinese][中文简介30147], [EN][英文简介30147])
    * Chip Datasheet ([Chinese][中文规格书30147], EN)



Retail samples and small quantities can be purchased directly on [Taobao](https://sifli.taobao.com/)(https://sifli.taobao.com/). Volume customers can email sales@sifli.com or contact customer service on Taobao to obtain sales contact information.
Samples can be requested free of charge for participating in open source. You can join QQ group 674699679 for discussion.
